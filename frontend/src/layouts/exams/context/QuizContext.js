...
function Provider({ children }) {
  ...
  // Logging quizzes to console
  console.log("from the local storage : ", quizzes);

  // Map the questions for each quiz
  ...
  // Map the quizzes questions into the desired format
